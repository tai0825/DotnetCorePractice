...
namespace DotnetCorePractice.Migrations
{
    ...
    [Migration("20200814143504_Table_Update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.Course", b =>
                {
                    b.HasOne("DotnetCorePractice.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.CourseInstructor", b =>
                {
                    b.HasOne("DotnetCorePractice.Models.Course", "Course")
                    ...
                    b.HasOne("DotnetCorePractice.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("DotnetCorePractice.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("DotnetCorePractice.Models.OfficeAssignment", b =>
                {
                    b.HasOne("DotnetCorePractice.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("DotnetCorePractice.Models.OfficeAssignment", "InstructorId")
